...
test_locate_G0 (void)
{
    TEST_ASSERT_TRUE(in_region_G0(-7.33057219e-02, -5.11934762e-01));
    TEST_ASSERT_TRUE(in_region_G0(-2.71670473e-01, -3.61159944e-01));
    TEST_ASSERT_TRUE(in_region_G0(+2.65104392e-01, +4.93166724e-01));
    TEST_ASSERT_TRUE(in_region_G0(+3.83251931e-01, -7.20912195e-01));
    TEST_ASSERT_TRUE(in_region_G0(+6.15420692e-01, +4.94737446e-01));
    TEST_ASSERT_TRUE(in_region_G0(+5.77022431e-01, +7.31978260e-01));
    TEST_ASSERT_TRUE(in_region_G0(+5.50863360e-01, +3.20026771e-01));
    TEST_ASSERT_TRUE(in_region_G0(+3.19070375e-01, -6.61764960e-01));
    TEST_ASSERT_TRUE(in_region_G0(-4.45577540e-01, -6.89742478e-01));
    TEST_ASSERT_TRUE(in_region_G0(+1.59189786e-01, +3.86077993e-02));
}
...
test_locate_G1 (void)
{
    ...
    TEST_ASSERT_TRUE(in_region_G1(+1.00809273e+01, +2.22251668e+00, alpha, acc));
    TEST_ASSERT_TRUE(in_region_G1(+4.22589759e+00, +9.54335685e+00, alpha, acc));
    TEST_ASSERT_TRUE(in_region_G1(+7.07970270e+00, -4.66671354e+00, alpha, acc));
    TEST_ASSERT_TRUE(in_region_G1(+1.03652185e+01, +2.66482346e+00, alpha, acc));
    TEST_ASSERT_TRUE(in_region_G1(+7.36990152e+00, +5.61334844e+00, alpha, acc));
    TEST_ASSERT_TRUE(in_region_G1(+1.02336488e+01, -1.44223606e+00, alpha, acc));
    TEST_ASSERT_TRUE(in_region_G1(+8.17467292e+00, -2.42910054e+00, alpha, acc));
    TEST_ASSERT_TRUE(in_region_G1(+4.34347484e+00, +6.98890345e+00, alpha, acc));
    TEST_ASSERT_TRUE(in_region_G1(+9.93249059e+00, +3.48082382e+00, alpha, acc));
    TEST_ASSERT_TRUE(in_region_G1(+5.72222055e+00, +5.86522403e+00, alpha, acc));
}
...
void
test_G2_complex_parameter (void)
{
    const double complex x = -7.0 + 0.0 * I;
    const double complex expected = cexp(x * x) * (1.0 + derf(x));
    const double complex computed = mittleff(0.5, 1.0, x);
    TEST_VALUE(expected, computed);
}
...
main (void)
{
    ...
    RUN_TEST(test_locate_G0);
    RUN_TEST(test_locate_G1);
    RUN_TEST(test_locate_G2);
    RUN_TEST(test_locate_G3);
    RUN_TEST(test_locate_G4);
    RUN_TEST(test_locate_G5);
    RUN_TEST(test_locate_G6);
