           ...
           const num_t acc)
{
    ...
    /* if (in_region_G0(z)) */
    /*     mittleff0(_res, alpha, beta, z, acc); */
    /* else if (num_gt(alpha, 1.0)) /\* apply recursive relation (2.2) *\/ */
    /* { */
    ...
    /*         mittleff1(_res, alpha, beta, z, acc); */
    /*     else if (in_region_G2(z, alpha, acc)) */
    /*         mittleff2(_res, alpha, beta, z, acc); */
    /*     else if (in_region_G3(z, alpha, acc)) */
    /*         mittleff3(_res, alpha, beta, z, acc); */
    /*     else if (in_region_G4(z, alpha, acc)) */
    /*         mittleff4(_res, alpha, beta, z, acc); */
    /*     else if (in_region_G5(z, alpha, acc)) */
    /*         mittleff5(_res, alpha, beta, z, acc); */
    /*     else if (in_region_G6(z, alpha, acc)) */
    /*         mittleff6(_res, alpha, beta, z, acc); */
    /*     else */
          ...
          const double acc)
{
    ...
    _acc = new(num);
    _res = new(num);
    num_set_d(_alpha, alpha);
    num_set_d(_beta, beta);
    num_set_d_d(_z, x, y);
    num_set_d(_acc, acc);
    num_zero(_res);
